...
typedef void(*ebpf_pop_events_t)(fim::BoundedQueue<std::unique_ptr<file_event>>& kernel_queue);
...
void ebpf_pop_events(fim::BoundedQueue<std::unique_ptr<file_event>>& kernel_queue);
